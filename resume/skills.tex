...
%---------------------------------------------------------
  \cvskill
    {Languages} % Category
    {Python~~~\textbullet~~~C~~~\textbullet~~~Java~~~\textbullet~~~SQL (Oracle PL/SQL, HiveQL)~~~\textbullet~~~JavaScript~~~\textbullet~~~SPARQL~~~\textbullet~~~MATLAB~~~\textbullet~~~Bash / AWK / Sed} % Skills
...
\cvskill
    ...
    {Microsoft Azure (HDInsight, ADLS)~~~\textbullet~~~Apache Ambari cluster monitoring} % Skills
